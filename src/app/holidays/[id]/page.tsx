...
export default function HolidayDetailPage({ params }: PageProps) {
  ...
  useEffect(() => {
    if (holiday?.name) {
      document.title = `${holiday.name} | Tailor Travels Luxury Escape`;
    }
  }, [holiday]);
              ...
              <div className="flex flex-col md:flex-row justify-between items-start mb-8 gap-4">
                <header>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="flex gap-0.5" aria-label={`Rating: ${holiday.ratingStars || 5} stars`}>
                      {[...Array(5)].map((_, i) => (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-[500px] md:h-[600px]">
                <div className="lg:col-span-8 relative rounded-3xl overflow-hidden group shadow-xl">
                  <Image 
                    ...
                    alt={`${holiday.name} - Luxury hotel view in ${holiday.location}`} 
                    fill 
                ...
                <div className="hidden lg:grid lg:col-span-4 grid-rows-2 gap-6">
                  <div className="relative rounded-3xl overflow-hidden shadow-lg">
                    <Image 
                      ...
                      alt={`${holiday.name} - Premium interior and suites`} 
                      fill 
                  ...
                  <div className="relative rounded-3xl overflow-hidden shadow-lg">
                    <Image 
                      ...
                      alt={`${holiday.name} - Infinity pool and relaxation area`} 
                      fill 
                      className="object-cover"
                    />
                  </div>
